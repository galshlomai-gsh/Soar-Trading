...
const avatars = [
  { src: "/Profile Images/Icon1.png", alt: "Funded Soar trader" },
  { src: "/Profile Images/Icon2.png", alt: "Funded Soar trader" },
  { src: "/Profile Images/Icon3.png", alt: "Funded Soar trader" },
];
...
function HeroMonitorsBackdrop() {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 -z-0">
      ...
      />
      <Image
        src="/Soar Graphic_Hero.png"
        alt=""
        fill
        priority
        sizes="100vw"
        className="absolute inset-0 object-cover object-right opacity-70 mix-blend-screen"
      />
      <div
        className="absolute inset-0 opacity-80"
        style={{
          background:
            "radial-gradient(900px 500px at 85% 30%, rgba(91,142,240,0.18), transparent 60%), radial-gradient(700px 400px at 10% 10%, rgba(143,184,255,0.10), transparent 60%), radial-gradient(600px 400px at 70% 95%, rgba(91,142,240,0.12), transparent 60%)",
        }}
      />
    </div>
  );
